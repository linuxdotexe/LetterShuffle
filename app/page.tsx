...
export default function Home() {
  const { bg, username, film } = useContext(DataContext);
  return (
    <main
      className={
        username === "" && film === "" ? `flex items-center justify-center` : ""
      }
    >
      {username === "" && film === "" ? (
        <>
          <div className="h-96 text-center md:w-1/2">
            <div
              className="fade-to-transparent absolute inset-0 -z-10 mx-auto h-96 w-full bg-cover bg-no-repeat lg:w-3/4"
              style={{
            ...
            <div className="flex items-center justify-center gap-1">
              <h1 className="text-3xl font-bold tracking-tight">
                Enter your username in that box above me
              </h1>
              <svg
